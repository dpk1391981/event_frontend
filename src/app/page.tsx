...
export const metadata: Metadata = {
  title: 'PlanToday — Plan Your Event in 2 Minutes | AI-Powered Vendor Matching Delhi NCR',
  description:
    'Get a complete event plan with budget breakdown and top vendor recommendations in 2 minutes. Wedding, birthday, corporate events across Noida, Delhi & Gurgaon. 2000+ verified vendors.',
  keywords: [
    'event planning Delhi NCR', 'wedding plan budget Noida', 'event vendor recommendations',
    'birthday party plan Noida', 'corporate event plan Gurgaon', 'wedding budget planner Delhi',
          ...
          <div className="ticker-track whitespace-nowrap text-xs text-gray-400">
            {[...Array(2)].map((_, ri) => (
              <span key={ri} className="flex items-center gap-6">
                {['Wedding Planning', 'Birthday Party Plan', 'Corporate Events', 'Venue + Catering', 'Photography Package', 'Decoration Bundle', 'DJ + Music', 'Bridal Makeup', 'Complete Event Plan', 'Free Budget Planner'].map((s) => (
