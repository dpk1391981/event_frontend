/**
 * PlanToday SVG icon library — no emojis, no external dependencies.
...
export function StoreIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 9l1.5-6h15L21 9M3 9h18M3 9v11a1 1 0 001 1h3v-5h4v5h3a1 1 0 001-1V9" />
    </svg>
  );
}
...
export function WeddingIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
...
export function CakeIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 15a2 2 0 01-2 2H5a2 2 0 01-2-2v-4a2 2 0 012-2h14a2 2 0 012 2v4zM3 15v4a1 1 0 001 1h16a1 1 0 001-1v-4" />
      <path strokeLinecap="round" d="M12 9V6m0 0a1 1 0 100-2 1 1 0 000 2z" />
    </svg>
  );
}
...
export function BriefcaseIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" d="M12 12v2m-6 0h12" />
    </svg>
  );
}
...
export function RobotIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" d="M12 8V5m0 0a2 2 0 110-4 2 2 0 010 4z" />
...
export function LeadsIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function TokenIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <circle cx="12" cy="12" r="9" />
      <path strokeLinecap="round" d="M12 7v2m0 6v2m-3-5h6" />
    </svg>
  );
}
...
export function CurrencyIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
